...
class TrainingLoopMetricLearning(pl.LightningModule):
  ...
  def __init__(self, backbone, num_classes, sub_centers=3):
    ...
    self.loss = losses.SubCenterArcFaceLoss(num_classes=num_classes, embedding_size=576, sub_centers=sub_centers)
