...
class TrainingLoopMetricLearningConsistentLoss(pl.LightningModule):
  ...
  def __init__(self, backbone, num_classes):
    ...
    self.loss = losses.SubCenterArcFaceLoss(num_classes=num_classes, embedding_size=576, sub_centers=1)
  ...
  def general_step(self, batch, stage, acc):
    ...
    # TODO: step consistent_loss * 20
    step_loss = step_metrics_loss + 20 * step_consistent_loss
